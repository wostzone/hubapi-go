...
// CreateForm creates a form object description how to connect to a Thing via the Hub
//
...
func CreateForm(op string, href string, contentType string, httpMethodName string) map[string]interface{} {
